	...
	def template_feature(self, token, label, index):
		...
		if label and (label[index] == ("O" or "o")): 
			...
			if label:
				...
				return (dict(f1=0, f2=0, f3=0, f4=0, f5=0, f6=0, f7=0), label[index])
			else:
				return (dict(f1=0, f2=0, f3=0, f4=0, f5=0, f6=0, f7=0))
		else:
			...
			# if token[index] == "kabupaten" or token[index] == "kota":
			if token[index] in self.gaz_org:
				f4 = False
			else:
			...
			# if label:
			# 	#apabila label ada, saat data train teranotasi
			# 	result = (dict(f1=f1, f2=f2, f3=f3, f4=f4, f5=f5, f6=f6, f7=f7), label[index])
			# else:
			# 	#apabila label tidak ada, saat data train tidak teranotasi
			# 	result = (dict(f1=f1, f2=f2, f3=f3, f4=f4, f5=f5, f6=f6, f7=f7))
